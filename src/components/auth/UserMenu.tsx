...
import { User, LogOut, Crown, Activity, ChevronDown, Shield } from 'lucide-react';
...
const UserMenu: React.FC = () => {
  ...
  const [profileModalTab, setProfileModalTab] = useState<'profile' | 'activity' | 'security'>('profile');
  ...
  const openProfileModal = (tab: 'profile' | 'activity' | 'security' = 'profile') => {
            ...
            <>
              ...
              >
                ...
                <div className="py-2">
                  ...
                  <button
                    onClick={() => openProfileModal('activity')}
                    className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                  >
