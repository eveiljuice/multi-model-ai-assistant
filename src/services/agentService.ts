...
Format responses as structured checklists with checkboxes.`,
...
Let's make serious topics enjoyable! 🎈`
  ...
  private getAgentModel(agentId: string): AIModel {
    ...
    const modelMap: Record<string, AIModel> = {
      '1': 'ChatGPT-4',     // Prompt Polisher - OpenAI for technical tasks
      '2': 'Claude-2',      // Competitor Analysis - Claude for analytics
      '3': 'ChatGPT-4',     // FAQ Generator - OpenAI for structured content
      '4': 'Claude-2',      // Problem → Insight - Claude for insights
      '5': 'ChatGPT-4',     // Launch Checklist - OpenAI for planning
      '6': 'Gemini-Pro',    // WhatsApp Response - Gemini for communication
      '7': 'Claude-2',      // AI → Human Rewriter - Claude for editing
      '8': 'Gemini-Pro'     // Humor Rewriter - Gemini for creativity
    };
    
    return modelMap[agentId] || 'ChatGPT-4';
  }
...
*Credits are used to ensure fair access to our AI agents and cover computational costs.*`,
          ...
          sender: 'agent',
          agentId: agent.id,
          model: this.getAgentModel(agent.id)
        };
      }
